...
const PRODUCTS = {
  parfums: [
    ...
    { name: "Yve Saint Laurant", note: "Épicé · Chaud · Mystérieux", badge: "Collection", image: parfum11 },
    { name: "Sauvage Dior", note: "Herbal · Naturel · Apaisant", badge: "Best-seller", image: parfum12 },
    { name: "Prada", note: "Vanillé · Doux · Gourmand", badge: "Nouveau", image: parfum13},
    { name: "ORCHID", note: "Aquatique · Léger · Marin", badge: "Exclusif", image: parfum14 },
    { name: "La Petite Rose Noir ", note: "Floral · Élégant · Féminin", badge: "Collection", image: parfum15 },
    { name: "Victoria Secret", note: "Musqué · Sensuel · Nocturne", badge: "Nouveau", image: parfum16 },
    { name: "Victoria Secret", note: "Musqué · Sensuel · Nocturne", badge: "Nouveau", image: parfum17},
    { name: " Vanilla Voyage", note: "Oriental · Riche · Charismatique", badge: "Nouveau", image: parfum18},
    { name: "My way", note: "Ambré · Chaud · Sensuel", badge: "Exclusif", image: parfum19},
    { name: "Hypnotic Poison", note: "Floral · Légère · Lumineuse", badge: "Collection", image: parfum20},
    { name: "L'interdit Givency", note: "Boisé · Mystérieux · Raffiné", badge: "Best-seller", image: parfum21 },
    { name: "Baccarat Rouge", note: "Aérien · Frais · Élégant", badge: "Signature", image: parfum22 },
  ],
  huiles: [
  ...
  lunettes: [
    ...
    { name: "Celine", note: "Oversize · Moderne · Chic", badge: "Tendance", image: lunette6 },
    { name: "Celine", note: "Carré · Minimaliste · Élégant", badge: "Classique", image: lunette7 },
    { name: "Yve Saint Laurant", note: "Rétro · Glamour · Futuriste", badge: "Glamour", image: lunette8 },
    { name: "Modèle Horizon", note: "Sport · Léger · Actif", badge: "Énergique", image: lunette9 },
    { name: "Modèle Cascade", note: "Papillon · Féminin · Délicat", badge: "Collection", image: lunette10 },
    { name: "Modèle Éclipse", note: "Aviateur · Authentique · Luxe", badge: "Signature", image: lunette11 },
    { name: "Loewe", note: "Rond · Doux · Raffiné", badge: "Nouveau", image: lunette12 },
    ...
    { name: "Cartier", note: "Round · Mystérieux · Élégant", badge: "Élégant", image: a8 },
    ...
    <div style={{ background:"#FAFAF9", minHeight:"100vh", color:"#1A1A2E", fontFamily:"'Nunito',sans-serif", overflowX:"hidden" }}>
      <style>{`
        ...
        *{margin:0;padding:0;box-sizing:border-box}
        ...
        .nav-contact{display:flex;gap:14px;align-items:center}
        .hamburger{display:none;flex-direction:column;gap:5px;cursor:pointer;padding:6px;border:none;background:none}
        .hamburger span{display:block;width:24px;height:2px;background:#C8405A;border-radius:2px;transition:all .3s}
        ...
        @media(max-width:900px){
          ...
          .mobile-menu-item{
            ...
            letter-spacing:.1em;text-transform:uppercase;color:#1A1A2E;
            padding:16px 0;border-bottom:1px solid rgba(0,0,0,0.06);
            transition:color .3s,padding-left .3s;
          }
          .mobile-menu-item:hover{color:#C8405A;padding-left:8px}
          .mobile-contact{margin-top:28px;display:flex;flex-direction:column;gap:14px}
          .hero-pad{padding:120px 24px 60px !important}
          .section-pad{padding:60px 20px !important}
          .footer-pad{padding:52px 20px 24px !important}
          .about-pad{padding:60px 20px !important}
          .nav-pad{padding:12px 20px !important}
        }

        @media(max-width:600px){
          .cta{padding:11px 20px;font-size:.62rem}
          .hero-logo{width:110px !important;height:110px !important}
      ...
      <div className={`mobile-menu${menuOpen ? " open" : ""}`}>
        {SECTIONS.map(s=>(
          <button key={s.key} className="mobile-menu-item" onClick={()=>goTo(s.key)}>
            {s.emoji} {s.label}
          </button>
        ))}
        <button className="mobile-menu-item" onClick={()=>goTo("about")}>✦ À Propos</button>
        <div className="mobile-contact">
          <a href="https://www.instagram.com/_lunea.store?igsh=d3ozaDZyMXY1Y3U=" target="_blank" rel="noreferrer"
            style={{ fontSize:".9rem", fontWeight:700, color:"#C8405A", textDecoration:"none" }}>
            📸 @lunea_store
          </a>
      ...
      {/* ══ À PROPOS ══ */}
      <section id="about" className="about-pad" style={{
        padding:"90px 48px",
      ...
      {/* ══ FOOTER ══ */}
      <footer className="footer-pad" style={{ background:"#12121E", padding:"68px 48px 30px" }}>
